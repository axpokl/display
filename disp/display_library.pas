...
procedure OpenFileW314(s:unicodestring);cdecl;
begin display.OpenFileW(s);end;
procedure CloseFile315();cdecl;
begin display.CloseFile();end;
function GetFileLen316():longword;cdecl;
begin GetFileLen316:=display.GetFileLen();end;
function GetFilePos317():longword;cdecl;
begin GetFilePos317:=display.GetFilePos();end;
procedure SetFilePos318(pos:longword);cdecl;
begin display.SetFilePos(pos);end;
function GetByte319():byte;cdecl;
begin GetByte319:=display.GetByte();end;
function GetWord320():word;cdecl;
begin GetWord320:=display.GetWord();end;
function GetLongword321():longword;cdecl;
begin GetLongword321:=display.GetLongword();end;
function GetInteger322():longword;cdecl;
begin GetInteger322:=display.GetInteger();end;
function GetPchar323():pchar;cdecl;
begin GetPchar323:=display.GetPchar();end;
function GetString324(len:longword):pchar;cdecl;
begin GetString324:=pchar(display.GetString(len));end;
exports GetString324;
exports GetPchar323;
exports GetInteger322;
exports GetLongword321;
exports GetWord320;
exports GetByte319;
exports SetFilePos318;
exports GetFilePos317;
exports GetFileLen316;
exports CloseFile315;
exports OpenFileW314;
exports OpenFile313;
